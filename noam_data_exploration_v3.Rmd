...
(shannon_cv_plot_2 = 
  ggplot(data = diversity_stability_quadrat) +
  geom_point(aes(x = Shannon_mean, y = Cover_cv, colour = Site, shape = Habitat), size = 4, stroke = 2) + 
   scale_colour_manual(values = site_colours) +
   scale_shape_manual(values = habitat_shapes) +
  facet_wrap(~Site) +
  theme_bw() + 
...
(loreau_stability_plot_quad = 
  ggplot(data = diversity_stability_quadrat) +
  geom_point(aes(x = Loreau_synchrony, y = Cover_cv, colour = Site, shape = Habitat), size = 4, stroke = 2) + 
   scale_colour_manual(values = site_colours) +
   scale_shape_manual(values = habitat_shapes) +
  facet_wrap(~Site) +
...
(loreau_diversity_plot_quad = 
  ggplot(data = diversity_stability_quadrat) +
  geom_point(aes(x = Shannon_mean, y = Loreau_synchrony, colour = Site, shape = Habitat), size = 4, stroke = 2) + 
   scale_colour_manual(values = site_colours) +
   scale_shape_manual(values = habitat_shapes) +
  facet_wrap(~Site) +
