...
```{r glmm approach, fig.height = 15, fig.width=20}
...
plot(mod_emm) +
  geom_point(aes(x = emmean, y = year_factor, colour = habitat))
  facet_wrap(island_side~habitat)
# model.sel(dredge(richness_mod_2))
  
emmip(richness_mod_2, island_side ~ year_factor | habitat, CIs = TRUE) +
  scale_colour_manual(values = island_side_colours) +
  scale_shape_manual(values = habitat_shapes) +
