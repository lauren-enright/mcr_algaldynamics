...
## HAD TO RUN TO CITY OFFICE FOR FAMILY SHIT AND COULDN'T FINISH THIS YET - NOAM AUG 08
# diversity_stability_site <- reduced_diversity_stability %>%
#   dplyr::group_by(island_side, site, habitat, site_habitat) %>%
#   dplyr::summarise(richness_mean = mean(richness_mean), 
#             richness_se = sd(richness_mean)/sqrt(n()),
#             richness_cv = mean(richness_cv),
#             shannon_mean = mean(shannon), 
#             shannon_se = sd(shannon)/sqrt(n()),
#             shannon_cv = CV(shannon),
#             shannon_stability = 1/CV(shannon), # Stability as defined by codyn and many others (including Pete in 2022 paper)
...
#             cover_se = sd(cover)/sqrt(n()),
#             cover_cv = CV(cover),
#             loreau_mean = mean(loreau_synchrony),
#             loreau_se = se(loreau_synchrony),
#             portfolio_mean = mean(portfolio_effect),
#             portfolio_se = se(portfolio_effect))
# 
