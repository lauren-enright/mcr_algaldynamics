...
supplemental_tables_tableS5_plot <- read.csv(here::here("data", "supplemental_tables_tableS5_sitelevel.csv"))
...
(supplmement5_site_dss <- ggarrange(figure_s5a, figure_s5b, figure_s5c, 
...
ggsave(filename = "output/supplement5_site_dss.png", supplmement5_site_dss, height = 30, width = 40)
