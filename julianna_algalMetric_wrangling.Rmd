...
algDiv %>% 
  ...
  rename(algae_cover = AlgCov_perc,
         algae_cover_hard = AlgCov_percHard,
         algae_richness = Richness,
...
quadData %>% 
  ...
  summarize(coral_cover_mean = mean(coral),
            N = n(),
            coral_cover_se = sd(coral)/sqrt(N),
            algae_cover_mean = mean(algae_cover),
            algae_cover_se = sd(algae_cover)/sqrt(N),
            algae_cover_hard_mean = mean(algae_cover_hard),
            algae_cover_hard_se = sd(algae_cover_hard)/sqrt(N),
...
```{r save}
write_csv(alltimeJoin, here(here("data/algal_metrics_all_time.csv")))
```
