...
## Anything below this line was to help identify missing data, overall taxa levels, etc. and does not need to be run to get a cleaned dataframe 
...
year_site_counts <- table(algae_wide$Year, algae_wide$Site_habitat)
...
# remove non-algae columns with subset
algae_wide_2 <- comb_wide[ , -which(names(comb_wide) %in% not_algae)]
