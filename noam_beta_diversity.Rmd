...
#### WARNING: THIS CHUNK TAKES ~2 DAYS TO RUN! SUGGESTEDF TO USE PROVIDED CSV FILES WITH ORDINATION DATA ######
...
# set.seed(1032) 
# # fringing_ord3 <- metaMDS(fringing_braymat, dist	= "bray", k = 3, trymax = 100) 
...
# set.seed(1032) 
# backreef_ord3 <- metaMDS(backreef_braymat, dist	= "bray", k = 3, trymax = 100) 
# backreef_ord3 # 
# 
# 
...
# 
# 
# write_csv(backreef.site.scores, here("data", "backreef_site_scores.csv"))
# write_csv(backreef.species.scores, here("data", "backreef_species_scores.csv"))
...
# set.seed(1032) 
# outer10_ord3 <- metaMDS(outer10_braymat, dist	= "bray", k = 3, trymax = 100) 
# outer10_ord3 # 
# 
# 
...
# 
# 
# write_csv(outer10.site.scores, here("data", "outer10_site_scores.csv"))
# write_csv(outer10.species.scores, here("data", "outer10_species_scores.csv"))
...
## set.seed(1032) 
## outer17_ord3 <- metaMDS(outer17_braymat, dist	= "bray", k = 3, trymax = 100) 
## outer17_ord3 # 
## 
## 
...
## 
## 
## write_csv(outer17.site.scores, here("data", "outer17_site_scores.csv"))
## write_csv(outer17.species.scores, here("data", "outer17_species_scores.csv"))
...
# full_subset <- data[!full_rows_to_remove,] # make sure rows are also removed from dataframe
# full_subset$stratum <- paste(full_subset$year,"-", full_subset$location, sep = "") # for merging with bray matrix later
...
# 
# full_columns_to_keep <- apply(full_species_matrix, 2, function(x) any(x >= 0.1))
