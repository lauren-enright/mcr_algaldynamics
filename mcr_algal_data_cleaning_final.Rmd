...
# Julianna is adding this code here IF we want it:
wide_alldata_filtered_cleaned_column_names %>% 
  mutate(location = gsub(" ", "_", str_to_lower(location)),
         ...
         ) # would want to save this then do it for the algae dataset as well


write.csv(wide_alldata_filtered_cleaned_column_names, "allbenthicdata_cleaned_colnames.csv", row.names = FALSE)
...
write.csv(wide_algaeonly_cleaned_column_names, "algaeonly_cleaned_colnames.csv", row.names = FALSE)
