...
# ggsave(filename = "output/figure_2v4.png", figure_2, height = 10, width = 22)
```
...
diversity_ranges_quad <- extract_ranges(alpha_diversity_quad_macro, "habitat", c("richness", "cover_trans"))
