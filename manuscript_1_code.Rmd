...
(figure_2b <- ggplot() +
  ...
  geom_jitter(data = alpha_diversity_site_macro, aes(x = year, y = richness, colour = habitat, alpha = 0.05), size = 2, width = 0.4, height = 0) +
...
#ggsave(filename = "output/figure_2.png", figure_2, height = 10, width = 20)
```
