...
pairs(data = alpha_diversity_site_macro, ~ richness + shannon + wave_power_adcp + mean_n + n_cv + mean_temp_c + mean_temp_range + herbivore_biomass + herbivore_richness + herbivore_shannon + herbivore_evenness)
...
pairs(data = alpha_diversity_quad, ~ richness + shannon + wave_power_adcp + mean_n + n_cv + mean_temp_c + mean_temp_range + herbivore_biomass + herbivore_richness + herbivore_shannon + herbivore_evenness)
...
pairs(data = alpha_diversity_quad_macro, ~ richness + shannon + wave_power_adcp + mean_n + n_cv + mean_temp_c + mean_temp_range + herbivore_biomass + herbivore_richness + herbivore_shannon + herbivore_evenness)
...
fringing_all_richness_mod_universal <- glmmTMB(richness ~ year + coral_cover_hard + mean_n + mean_temp_c +  herbivore_evenness + offset(log(hard_cover)) + (1|site), family = poisson, data = fringing_all_site, na.action = na.pass) # universal model has convergence issues
fringing_all_richness_dredge <- dredge(fringing_all_richness_mod_universal) # most models have convergence issues
...
fringing_all_shannon_mod_universal <- glmmTMB(log(shannon + 1) ~ year + coral_cover_hard + mean_n + mean_temp_c +  herbivore_evenness + (1|site), data = fringing_all_site, na.action = na.pass)
fringing_all_shannon_dredge <- dredge(fringing_all_shannon_mod_universal) 
model.sel(fringing_all_shannon_dredge) # tie for the top model - best includes year and coral cover or just nitrogen
fringing_all_shannon_top_mod1 <- glmmTMB(log(shannon + 1) ~ year + coral_cover_hard + (1|site), data = fringing_all_site, na.action = na.pass)
fringing_all_shannon_top_mod2 <- glmmTMB(log(shannon + 1) ~ mean_n + mean_temp_c + (1|site), data = fringing_all_site, na.action = na.pass)
hist(residuals(fringing_all_shannon_top_mod1)) # slightly bimodal
hist(residuals(fringing_all_shannon_top_mod2)) # also uniform - neither are great
plot(residuals(fringing_all_shannon_top_mod1) ~ fitted(fringing_all_shannon_top_mod1)) # slight patterning
plot(residuals(fringing_all_shannon_top_mod2) ~ fitted(fringing_all_shannon_top_mod2)) # similar here
...
backreef_all_richness_mod_universal <- glmmTMB(richness ~ year + coral_cover_hard + wave_power_adcp + mean_n + mean_temp_c +  herbivore_evenness + offset(log(hard_cover)) + (1|site), family = poisson, data = backreef_all_site, na.action = na.pass) # universal model has convergence issues
...
backreef_all_richness_top_mod <- glmmTMB(richness ~ year + coral_cover_hard + offset(log(hard_cover)) + (1|site), family = poisson, data = backreef_all_site, na.action = na.pass)
...
backreef_all_shannon_mod_universal <- glmmTMB(log(shannon + 1) ~ year + coral_cover_hard + wave_power_adcp + mean_n + mean_temp_c +  herbivore_evenness + (1|site), data = backreef_all_site, na.action = na.pass)
backreef_all_shannon_dredge <- dredge(backreef_all_shannon_mod_universal) 
model.sel(backreef_all_shannon_dredge) #  best includes just coral cover 
backreef_all_shannon_top_mod <- glmmTMB(log(shannon + 1) ~  coral_cover_hard + (1|site), data = backreef_all_site, na.action = na.pass)
hist(residuals(backreef_all_shannon_top_mod)) # pretty good
...
outer10_all_richness_mod_universal <- glmmTMB(richness ~ year + coral_cover_hard + wave_power_adcp  + mean_temp_c +  herbivore_evenness + offset(log(hard_cover)) + (1|site), family = poisson, data = outer10_all_site, na.action = na.pass) # universal model has convergence issues
outer10_all_richness_dredge <- dredge(outer10_all_richness_mod_universal) # most models have convergence issues
model.sel(outer10_all_richness_dredge) # top model includes just intercept... next best is coral 
outer10_all_richness_top_mod <- glmmTMB(richness ~ coral_cover_hard + offset(log(hard_cover)) + (1|site), family = poisson, data = outer10_all_site, na.action = na.pass)
summary(outer10_all_richness_top_mod)
hist(residuals(outer10_all_richness_top_mod)) #  not bad
plot(residuals(outer10_all_richness_top_mod) ~ fitted(outer10_all_richness_top_mod)) # looks fine

outer10_all_shannon_mod_universal <- glmmTMB(log(shannon + 1) ~ year + coral_cover_hard + wave_power_adcp  + mean_temp_c +  herbivore_evenness + (1|site), data = outer10_all_site, na.action = na.pass)
outer10_all_shannon_dredge <- dredge(outer10_all_shannon_mod_universal) # some convergence issues
model.sel(outer10_all_shannon_dredge) #  best includes just herbivore evenness - first time there's been a decent gap in AICc
outer10_all_shannon_top_mod <- glmmTMB(log(shannon + 1) ~  herbivore_evenness + (1|site), data = outer10_all_site, na.action = na.pass)
hist(residuals(outer10_all_shannon_top_mod)) # pretty good
...
outer17_all_richness_mod_universal <- glmmTMB(richness ~ year + coral_cover_hard + wave_power_adcp  + mean_temp_c +  offset(log(hard_cover)) + (1|site), family = poisson, data = outer17_all_site, na.action = na.pass) # universal model has convergence issues
outer17_all_richness_dredge <- dredge(outer17_all_richness_mod_universal) # most models have convergence issues
model.sel(outer17_all_richness_dredge) # top model includes just intercept... next best is coral 
outer17_all_richness_top_mod <- glmmTMB(richness ~ coral_cover_hard + offset(log(hard_cover)) + (1|site), family = poisson, data = outer17_all_site, na.action = na.pass)
summary(outer17_all_richness_top_mod)
hist(residuals(outer17_all_richness_top_mod)) #  not bad
plot(residuals(outer17_all_richness_top_mod) ~ fitted(outer17_all_richness_top_mod)) # looks fine

outer17_all_shannon_mod_universal <- glmmTMB(log(shannon + 1) ~ year + coral_cover_hard + wave_power_adcp  + mean_temp_c + (1|site), data = outer17_all_site, na.action = na.pass)
outer17_all_shannon_dredge <- dredge(outer17_all_shannon_mod_universal) # some convergence issues
model.sel(outer17_all_shannon_dredge) #  best includes just year
outer17_all_shannon_top_mod <- glmmTMB(log(shannon + 1) ~  year + (1|site), data = outer17_all_site, na.action = na.pass)
hist(residuals(outer17_all_shannon_top_mod)) # pretty good
...
shannon_cv_emm_site <- emmip(shannon_cv_site,
                        ...
                        at = list(algae_shannon_mean = seq(0,10,0.1)), plotit = F, CIs = T)
...
(synchrony_richness_plot = 
  ...
  geom_line(data = filtered_synchrony_richness_effects_site, aes(x = algae_richness_mean, y = exp(yvar), colour = habitat), size = 2) +
  geom_ribbon(data = filtered_synchrony_richness_effects_site, aes(x = algae_richness_mean, ymin = exp(LCL), ymax = exp(UCL), fill = habitat),
              alpha = 0.3) +
   scale_colour_manual(values = habitat_colours) +
  scale_fill_manual(values = habitat_colours) +
  theme_bw() + 
...
(synchrony_shannon_plot = 
  ...
  geom_line(data = filtered_synchrony_shannon_effects_site, aes(x = algae_shannon_mean, y = exp(yvar), colour = habitat), size = 2) +
  geom_ribbon(data = filtered_synchrony_shannon_effects_site, aes(x = algae_shannon_mean, ymin = exp(LCL), ymax = exp(UCL), fill = habitat),
              alpha = 0.3) +
   scale_colour_manual(values = habitat_colours) +
  scale_fill_manual(values = habitat_colours) +
  theme_bw() + 
...
emtrends(synchrony_cv_site_macro, pairwise ~ habitat, var = "loreau_synchrony") # backreef different from outer17
...
(synchrony_richness_plot = 
  ...
  geom_point(data = diversity_stability_site_macro,
             aes(x = algae_richness_mean, y = loreau_synchrony, colour = habitat), size = 2, alpha = 0.5) + 
  geom_line(data = filtered_synchrony_richness_effects_site_macro, aes(x = algae_richness_mean, y = exp(yvar), colour = habitat), size = 2) +
  geom_ribbon(data = filtered_synchrony_richness_effects_site_macro, aes(x = algae_richness_mean, ymin = exp(LCL), ymax = exp(UCL), fill = habitat),
              alpha = 0.3) +
   scale_colour_manual(values = habitat_colours) +
  scale_fill_manual(values = habitat_colours) +
  theme_bw() + 
...
(synchrony_shannon_plot = 
  ...
  geom_point(data = diversity_stability_site_macro,
             aes(x = algae_shannon_mean, y = loreau_synchrony, colour = habitat), size = 2, alpha = 0.5) + 
  geom_line(data = filtered_synchrony_shannon_effects_site_macro, aes(x = algae_shannon_mean, y = exp(yvar), colour = habitat), size = 2) +
  geom_ribbon(data = filtered_synchrony_shannon_effects_site_macro, aes(x = algae_shannon_mean, ymin = exp(LCL), ymax = exp(UCL), fill = habitat),
              alpha = 0.3) +
   scale_colour_manual(values = habitat_colours) +
  scale_fill_manual(values = habitat_colours) +
  theme_bw() + 
